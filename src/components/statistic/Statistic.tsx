...
const Statistic: FC = () => {
    return (
        <section className={classes.statistic}>
            ...
            <Image className={classes.statistic__img} src='images/statistic.svg' alt='Эпидемиологическое распределение ХОБЛ среди мужчин и женщин, %' width={1211} height={389}></Image>
        </section>
    );
};
